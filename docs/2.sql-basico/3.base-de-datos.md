...
**PostgreSQL** (frecuentemente llamado **Postgres**) es un sistema de gestión de bases de datos relacionales (RDBMS) avanzado, de código abierto y gratuito. Es reconocido mundialmente por su **enorme rango de funciones avanzadas**, su alta **estabilidad** y su excelente reputación en cuanto a **rendimiento**.

Características principales:

*   **Naturaleza y Costo:** Es uno de los proyectos de código abierto más antiguos, desarrollado por una comunidad global diversa durante más de 30 años. Al tener una licencia permisiva, ofrece un **bajo costo total de propiedad**, ya que no requiere el pago de regalías.

*   **Capacidades y Flexibilidad:** Aunque es principalmente relacional, admite modelos de datos "post-relacionales" como **JSON (NoSQL)**, XML, arreglos y clave-valor. Es altamente **extensible**, permitiendo a los usuarios definir sus propios tipos de datos, operadores y funciones en diversos lenguajes de programación.

*   **Rendimiento y Concurrencia:** Utiliza una técnica llamada **MVCC** (Control de Concurrencia Multiversión), que permite que los procesos de lectura y escritura no se bloqueen entre sí, mejorando drásticamente el rendimiento en entornos multiusuario.

*   **Robustez y Seguridad:** Está diseñado para ser un software de alta calidad con fuertes garantías de escritura en disco para evitar la pérdida de datos. Incluye características de seguridad de grado militar, como **Seguridad a Nivel de Fila (RLS)** y soporte nativo para cifrado SSL.

*   **Compatibilidad:** Sigue muy de cerca los estándares internacionales de **SQL (ANSI/ISO)** y es compatible con múltiples plataformas, incluyendo Windows, macOS y sistemas basados en Linux.

Se considera una alternativa de código abierto robusta y escalable frente a sistemas comerciales como Oracle o SQL Server, siendo capaz de manejar desde pequeñas aplicaciones hasta bases de datos de varios terabytes.
...
<figcaption>**Monitor de actividad**. Permite analizar el rendimiento de la base de datos.</figcaption>
</figure>
</center>
...
<figcaption>**Visor de datos**. Muestra los resultados de las consultas realizadas.</figcaption>
</figure>
</center>
...
<figcaption>**Analizador de geometrías**. Con capacidad de georeferenciación.</figcaption>
</figure>
</center>
...
<figcaption>**Analizador de estructura**. Modelo gráfico para analizar la estructura de la base de datos.</figcaption>
</figure>
</center>
...
<figcaption>**Edición de datos**. Muestra y permite la edición de los resultados de las consultas realizadas.</figcaption>
</figure>
</center>
...
<figcaption>**Editor de SQL**. Un potente editor de guiones SQL.</figcaption>
</figure>
</center>
...
<figcaption>**Diagrama MER**. Editor gráfico de las relaciones dentro de la base de datos.</figcaption>
</figure>
</center>
